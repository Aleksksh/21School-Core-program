...
START_TEST(strcmp_1) {
  char str[] = " \n\0\0";
  char str1[] = " a\n\0";
  ck_assert_int_eq((strcmp(str, str1) < 0), (s21_strcmp(str, str1) < 0));
}
END_TEST
...
START_TEST(strcmp_16) {
  ...
  char str_11[] = "Hello";
  char str_12[] = "lo";
  ck_assert_int_eq((strcmp(str_1, str_7) < 0), (s21_strcmp(str_1, str_7) < 0));
  ck_assert_int_eq((strcmp(str_11, str_12) < 0),
                   (s21_strcmp(str_11, str_12) < 0));
  ck_assert_int_eq((strcmp("", str_6) < 0), (s21_strcmp("", str_6) < 0));
  ck_assert_int_eq((strcmp(str_4, "") > 0), (s21_strcmp(str_4, "") > 0));
  ck_assert_int_eq((strcmp(str_5, str_6) < 0), (s21_strcmp(str_5, str_6) < 0));
  ck_assert_int_eq((strcmp(str_6, str_5) > 0), (s21_strcmp(str_6, str_5) > 0));
}
END_TEST
...
START_TEST(strcmp_19) {
  char *s1 = "QWERTY";
  char *s2 = "E";
  ck_assert_int_eq((strcmp(s1, s2) > 0), (s21_strcmp(s1, s2) > 0));
}
END_TEST
